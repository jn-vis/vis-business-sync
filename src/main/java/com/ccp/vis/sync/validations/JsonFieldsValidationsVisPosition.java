...
@ValidationRules(
		...
		simpleObject = {
				@SimpleObject(rule = SimpleObjectValidations.requiredFields, fields = { "title", "description",
						...
						"disponibility", "pcd", "sortFields", "frequency", "channel" }),
				@SimpleObject(rule = SimpleObjectValidations.requiredAtLeastOne, fields = { "btc", "clt", "pj" }),
				@SimpleObject(rule = SimpleObjectValidations.nonRepeatedLists, fields = { "ddd", "seniority",
						"desiredSkill", "mandatorySkill", "sortFields", "channel" }),
				@SimpleObject(rule = SimpleObjectValidations.integerFields, fields = { "disponibility" }),
				@SimpleObject(rule = SimpleObjectValidations.booleanFields, fields = { "pcd" }),
		...
		simpleArray = {
				...
				@SimpleArray(rule = SimpleArrayValidations.notEmptyArray, fields = { "ddd", "seniority",
						"mandatorySkill", "sortFields" }),
