...
@ValidationRules(
		...
		simpleObject = {
				@SimpleObject(rule = SimpleObjectValidations.requiredFields, fields = { "ddd",
						"disabilities", "companiesNotAllowed", "disponibility", "observations", "resumeBase64",
						"resumeWords", "resumeText", "desiredJob", "lastJob", "experience" }),
		...
		, allowedValues = {
				...
				@AllowedValues(rule = AllowedValuesValidations.arrayWithAllowedNumbers, fields = { "ddd" },
