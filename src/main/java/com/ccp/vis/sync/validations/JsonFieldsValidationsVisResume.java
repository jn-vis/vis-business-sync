...
@ValidationRules(
		...
		simpleObject = {
				@SimpleObject(rule = SimpleObjectValidations.requiredFields, fields = { "ddd", "disabilities",
						"companiesNotAllowed", "disponibility", "observations", "resumeBase64", "resumeWords",
						"resumeText", "desiredJob", "lastJob", "experience" }),
				...
				@SimpleObject(rule = SimpleObjectValidations.nonRepeatedLists, fields = { "ddd", "disabilities",
						"companiesNotAllowed", "resumeWords" }),
		...
		, allowedValues = {
				...
				@AllowedValues(rule = AllowedValuesValidations.arrayWithAllowedTexts, fields = { "disabilities" },
						allowedValues = { "física/motora", "intelectual/mental", "visual", "auditiva" })//TODO COMO INTERNACIONALIZAR ISSO???
		...
		objectTextSize = {
				...
				@ObjectTextSize(rule = ObjectTextSizeValidations.equalsOrLessThan, fields = { "desiredJob",
						"lastJob" }, bound = 100),
				@ObjectTextSize(rule = ObjectTextSizeValidations.equalsOrGreaterThan, fields = {"name", "github"}, 
				bound = 10), 
				@ObjectTextSize(rule = ObjectTextSizeValidations.equalsOrLessThan, fields = {"name"}, 
				bound = 50), 
				@ObjectTextSize(rule = ObjectTextSizeValidations.equalsOrLessThan, fields = {"github"}, 
				bound = 200), 
